...
interface JobsTrackerPluginInstance {
...
const JobsTrackerPlugin: JobsTrackerPluginInstance = {
  ...
  async loadPlugin(): Promise<PluginLoadResult> {
    ...
    PenPal.Jobs = {
      ...
      RequestCancellation: API.requestCancellation,
      ConfirmCancelled: API.confirmCancelled,
