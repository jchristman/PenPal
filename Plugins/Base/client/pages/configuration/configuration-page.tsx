...
const transform_key = (key: string): string => key.replaceAll("_", " ");

interface ConfigurationPageSectionProps {
...
const ConfigurationPageSection: React.FC<ConfigurationPageSectionProps> = ({
  handleConfigChange,
  path,
  config,
  depth = 0,
...
const ConfigurationPage: React.FC<ConfigurationPageProps> = ({ localConfig, handleConfigChange }) => {
