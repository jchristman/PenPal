...
import GetDashboardablePluginsQuery from "./dashboard/queries/get-dashboardable-plugins.ts";
...
const Dashboard: React.FC = () => {
  ...
  const [availableDashboardData, setAvailableDashboardData] = useState<any>({});
