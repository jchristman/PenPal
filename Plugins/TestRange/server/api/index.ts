...
import { TestRangeLogger } from "../plugin.ts";
 ...
 */
export const getContainerInfo = async (containerId: string): Promise<ContainerInfo | null> => {
  try {
 ...
 */
export const getAvailableContainers = async (): Promise<VulhubContainer[]> => {
  try {
 ...
 */
export const getRecentContainers = async (limit: number = 50): Promise<any[]> => {
  try {
