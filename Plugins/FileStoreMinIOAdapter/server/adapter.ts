...
import { FileStoreMinIOAdapterLogger as logger } from "./plugin.ts";

interface MinIOAdapterInstance {
  client: Minio.Client | null;
  connected: boolean;
  connect: () => Promise<void>;
  waitForConnection: (maxRetries?: number, baseDelay?: number) => Promise<void>;
  ...
  UploadFile: (bucket_name: string, file_name: string, file_data: any, options?: any) => Promise<any>;
  DownloadFile: (bucket_name: string, file_name: string) => Promise<any>;
  DeleteFile: (bucket_name: string, file_name: string) => Promise<any>;
  ListFiles: (bucket_name: string, options?: any) => Promise<any>;
  GetFileInfo: (bucket_name: string, file_name: string) => Promise<any>;
  GetUploadStream: (bucket_name: string, file_name: string, options?: any) => Promise<any>;
  GetDownloadStream: (bucket_name: string, file_name: string) => Promise<any>;
  GenerateUploadUrl: (bucket_name: string, file_name: string, options?: any) => Promise<any>;
  GenerateDownloadUrl: (bucket_name: string, file_name: string, options?: any) => Promise<any>;
}

const MinIOAdapter: MinIOAdapterInstance = {} as any;
MinIOAdapter.client = null;
MinIOAdapter.connected = false;

MinIOAdapter.connect = async (): Promise<void> => {
...
MinIOAdapter.waitForConnection = async (maxRetries: number = 10, baseDelay: number = 1000): Promise<void> => {
...
MinIOAdapter.isReady = async (): Promise<boolean> => {
  try {
...
MinIOAdapter.CreateBucket = async (bucket_name: string, options: any = {}): Promise<any> => {
  try {
...
MinIOAdapter.DeleteBucket = async (bucket_name: string): Promise<any> => {
  try {
...
MinIOAdapter.ListBuckets = async (): Promise<any> => {
  try {
...
MinIOAdapter.DownloadFile = async (bucket_name: string, file_name: string): Promise<any> => {
  try {
...
MinIOAdapter.DeleteFile = async (bucket_name: string, file_name: string): Promise<any> => {
  try {
...
MinIOAdapter.GetFileInfo = async (bucket_name: string, file_name: string): Promise<any> => {
  try {
...
MinIOAdapter.ListFiles = async (bucket_name: string, options: any = {}): Promise<any> => {
  try {
...
MinIOAdapter.GetUploadStream = async (bucket_name: string, file_name: string, file_info: any): Promise<any> => {
  try {
...
MinIOAdapter.GetDownloadStream = async (bucket_name: string, file_name: string): Promise<any> => {
  try {
