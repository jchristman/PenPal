...
import GetProjectDetails from "./queries/get-project-details.ts";

const { useToast, Card } = Hooks;

const ProjectView = ({ project_id, disable_polling = false }: { project_id: string; disable_polling?: boolean }) => {
