...
import getVulnerabilitiesInformation from "./queries/get-vulnerabilities-information.ts";
...
interface ProjectViewDashboardProps {
  project: Project;
}

const ProjectViewDashboard: React.FC<ProjectViewDashboardProps> = ({ project }) => {
  ...
  const nucleiVulns =
    vulnerabilities.filter((v: any) => v.discoveredBy === "Nuclei").length || 0;
