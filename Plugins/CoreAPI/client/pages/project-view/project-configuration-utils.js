...
const pluginSummarizers = new Map();
...
const pluginDetailedSummarizers = new Map();
 ...
 */
export const registerPluginSummarizer = (pluginName, summarizerFn) => {
 ...
 */
export const registerPluginDetailedSummarizer = (pluginName, detailedSummarizerFn) => {
 ...
 */
export const summarizePluginConfig = (pluginName, config) => {
 ...
 * @returns {string} Human-readable summary
 */
const generateGenericSummary = (config) => {
  const summaries = [];
 ...
 */
export const getPluginDisplayName = (pluginId) => {
 ...
 */
export const getDetailedConfigSummary = (pluginId, config) => {
 ...
 */
const getGenericDetailedSummary = (config) => {
  const details = [];
 ...
 */
export const formatPluginConfig = (pluginName, config) => {
  return {
