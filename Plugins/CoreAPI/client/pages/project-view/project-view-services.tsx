...
import getServicesInformation from "./queries/get-services-information.ts";

const { useToast } = Hooks;

const ProjectViewServices = ({ project, disable_polling }: { project: any; disable_polling?: boolean }) => {
