...
const TimelineItem = ({ project }: { project: Project }) => {
    ...
    >
      <CardHeader>
        ...
        <div className="flex items-center space-x-2 text-sm text-muted-foreground pt-1">
          ...
          <span>{project.customer?.name || "Not assigned"}</span>
        </div>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-3 gap-2 pt-4 border-t border-border/50 text-xs">
          <div className="flex items-center space-x-1.5">
            ...
            <span className="font-semibold">{project.stats?.networks || 0}</span>
            <span className="text-muted-foreground">Networks</span>
          </div>
          <div className="flex items-center space-x-1.5">
            <ComputerDesktopIcon className="h-4 w-4 text-muted-foreground" />
            <span className="font-semibold">{project.stats?.totalHosts || 0}</span>
            <span className="text-muted-foreground">Hosts</span>
          </div>
          <div className="flex items-center space-x-1.5">
            <ServerIcon className="h-4 w-4 text-muted-foreground" />
            <span className="font-semibold">{project.stats?.totalServices || 0}</span>
