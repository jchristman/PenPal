...
const ProfileSelector = ({
  ...
  const selectedProfile = getPluginProfiles.find((p: any) => p.id === value);
...
const ProjectDetailsForm = ({
  ...
  setProjectStartDate: (date: Date | undefined) => void;
  projectEndDate: Date | undefined;
  setProjectEndDate: (date: Date | undefined) => void;
  projectProfile: string;
  setProjectProfile: (value: string) => void;
}) => {
  const [popoverOpen, setPopoverOpen] = useState(false);
  const handleProjectNameChange = (event: any) =>
    setProjectName(event.target.value);
  const handleProjectDescriptionChange = (event: any) =>
