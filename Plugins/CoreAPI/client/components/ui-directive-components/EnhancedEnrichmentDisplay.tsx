...
interface EnhancedEnrichmentDisplayProps {
  enrichment: any;
}

const EnhancedEnrichmentDisplay: React.FC<EnhancedEnrichmentDisplayProps> = ({
  enrichment,
}) => {
  ...
  const resolvedTypename =
    __typename || (plugin_name ? `${plugin_name}PluginEnrichment` : null);

  // Build flat enrichment object
  let flatEnrichment =
    enrichmentData && typeof enrichmentData === "object"
      ? {
          __typename: resolvedTypename,
          plugin_name,
          ...enrichmentData,
          ...rest,
        }
  ...
  if (
    !flatEnrichment.screenshot_url &&
    flatEnrichment.screenshot_bucket &&
    flatEnrichment.screenshot_key
  ) {
  ...
  if (process.env.NODE_ENV !== "production") {
    ...
    console.log(
      "[EnhancedEnrichmentDisplay] Resolved __typename:",
      resolvedTypename
    );
  }
