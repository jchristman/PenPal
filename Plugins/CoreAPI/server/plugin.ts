...
import type { PluginModule, PluginLoadResult } from "#penpal/common";
...
} from "./api/ui-directives.ts";
import { mocks } from "./test/index.ts";
import {
  FileAttachmentType,
...
} from "../common/file-attachment-constants.ts";
...
const CoreAPIPlugin: PluginModule = {
