...
interface ScanQueueInstance {
  queue: QueueItem[];
  isProcessing: boolean;
  currentJob: any;
  keepAliveInterval: NodeJS.Timeout | null;
  currentlyProcessingOperation: QueueItem | null;
  totalOperationsInCurrentJob: number;
  completedOperationsInCurrentJob: number;

  add(asyncFunction: () => Promise<void>, queueName?: string | null): Promise<void>;
  createQueueJob(): Promise<void>;
  addStageToJob(): Promise<void>;
...
class ScanQueue implements ScanQueueInstance {
  constructor() {
    this.queue = [];
  ...
  async add(asyncFunction: () => Promise<void>, queueName: string | null = null): Promise<void> {
    ScanQueueLogger.log(
  ...
  async createQueueJob(): Promise<void> {
  ...
  async addStageToJob(): Promise<void> {
...
const ScanQueuePlugin: PenPalPlugin = {
